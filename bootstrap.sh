...
print_help () {
	...
	echo ""
	echo "  Bootstraps a base system or new host systems. Target may be"
	...
	echo ""
	echo "  Useful proxies (http_proxy=...):"
	echo "    Local host                 : http://localhost:3142/"
	echo "    Host from VirtualBox guest : http://10.0.2.2:3142/"
	echo "    Host from Docker container : http://172.17.42.1:3142/"
	echo ""
	exit 1
}
